        ...
        <v-col class="px-0">
          <v-row class="d-flex justify-space-between px-8 py-6" align="center">
            ...
            <v-card-action>
              ...
              <v-btn variant="text" @click="deleteJournal(journal.id)" class="text-subtitle-1">
          ...
          <v-card-subtitle class="pt-2"> Share your journal to: </v-card-subtitle>
          <v-row class="py-6 px-7">
            <Button class="mr-5 bg-grey-lighten-2" elevation="5" :noSpacing="false" icon="mdi-facebook">Facebook</Button>
            <Button class="mr-5 bg-grey-lighten-2" elevation="5" :noSpacing="false" icon="mdi-reddit">Reddit</Button>
            <Button class="mr-5 bg-grey-lighten-2" elevation="5" :noSpacing="false" icon="mdi-instagram">Instagram</Button>
          </v-row>
        </v-col>
      </v-card>
    </v-col>
